...
Page({
  ...
  getDateArray: function (endDate, splitTime, count) {
    ...
    that.setData({ dateArray: dateobj})
    return dateobj;
},
  ...
  toSuccess: function () {
    ...
    var kvinfos = {
      "RGUID": "",
      "PhoneNo": phone, "ShopNo": shopno, "MutexSign": MutexSign,
      "TaskID": "5", "TaskName": "预约", "TaskJson": taskjson,
      "TaskTime": "", "TaskSrc": sysinfo.brand + " " + sysinfo.model, "TaskState": "1", "TaskResult": "",      "AstA": app.globalData.authorizerId
    }
    //console.log(kvinfos)
    //return false
  ...
  toSelectTime:function(e){
    ...
    this.setData({ SelectedTime: SelectedTime})
    this.hideTPTime()
  },
